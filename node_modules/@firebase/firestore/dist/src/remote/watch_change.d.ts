...
export declare class WatchChangeAggregator {
     ...
     */
    private getCurrentDocumentCountForTarget(targetId);
    /**
     * Increment the number of acks needed from watch before we can consider the
     * server to be 'in-sync' with the client's active targets.
     */
    recordPendingTargetRequest(targetId: TargetId): void;
    private ensureTargetState(targetId);
    private ensureDocumentTargetMapping(key);
    /**
     ...
     * from all documents).
     */
    private resetTarget(targetId);
    /**
     * Returns whether the LocalStore considers the document to be part of the
     * specified target.
     */
    private targetContainsDocument(targetId, key);
}
=======
/**
 * Copyright 2017 Google Inc.
